...
npx -p @angular/cli@14.2.11 ng new minsait-ng_dev-23_05

## Sample Repository

[Repository on GitHub](https://github.com/TrainingITCourses/minsait-ng_dev-23_05)

```bash
# clone repository
git clone https://github.com/TrainingITCourses/minsait-ng_dev-23_05.git
# Execute
cd minsait-ng_dev-23_05
npm install
npm start
```
